...
//
//  Processore dell'outbox condiviso da tutti i moduli (ADR-0006, ADR-0027).
//  Prova a spedire ogni `OutboxEntry` in ordine; su successo elimina l'entry
//  e marca il modello come sincronizzato; su errore classifica l'errore e
//  applica il backoff di `SyncPolicy`. I `send`/`markSynced` conoscono i kind
//  di gym + diet.
//
