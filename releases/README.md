...
| `1r0-pkm-1.0-20260911-b4.ipa` | 1.0 (4) | `629365c` | tutto quanto sopra + alimenti semplici nei template + modifica/retroattività pasti pianificati (ADR-0032) + database prod separato (ADR-0033) + switch dev/prod in Impostazioni (ADR-0034) | beta. HealthKit non verificato su device; backend HTTP (`100.31.154.129`), niente HTTPS. Punta al database di **produzione** per default (switch in Impostazioni per quello di sviluppo). |
